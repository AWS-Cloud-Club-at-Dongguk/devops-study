...
> **SPOF란?** <br>
> 시스템의 한 부분에서 장애가 발생했을 때 전체 시스템의 작동을 멈추게 하는 요소나 구성 요소를 말한다.
...
> - 국 델라웨어 대학의 데이빗 밀스에 의해 처음 개발되었으나, 이제는 인터넷 표준이 되었다. 
> - NTP는 컴퓨터 클록 시간을 1/1000 초 이하까지 동기화시키기 위해 협정 세계시각(UTC)을 사용하게 된다.